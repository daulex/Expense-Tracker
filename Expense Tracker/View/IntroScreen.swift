    ...
    var body: some View{
        VStack(spacing: 15){
            ...
            VStack(alignment: .leading, spacing: 25, content:{
                ...
                PointView(symbol: "magnifyingglass", title: "Advanced Filters", subTitle: "Find the expenses you want using advanced search and filtering.")
            })
            ...
            Button(action:{
                ...
                Text("Continue")
                    ...
                    .background(appTint.gradient, in: .rect(cornerRadius: 8))
                    .contentShape(.rect)
            })
        }
        .padding(15)
